...
static const byte MCP2517_SDI =  19 ; // SDI input of MCP2517
static const byte MCP2517_SDO =  22 ; // SDO output of MCP2517

static const byte MCP2517_CS  = 21 ; // CS input of MCP2517
static const byte MCP2517_INT = 15 ; // INT output of MCP2517
...
void setup() {
  ...
  ACAN2517FDSettings settings(
      ACAN2517FDSettings::OSC_20MHz, 1000 * 1000, DataBitRateFactor::x1);
...
void loop() {
  ...
  Serial.println(F("Printing state"));
  print_state();
